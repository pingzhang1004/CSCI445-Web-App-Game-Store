...
<div class="grid-container">
    <div class="main-comtent" id="content">
        <form action="Unit3_process_order.php" method="post" onchange="updateImage()">
...
<script>
    ...
    function updateMaxQuantity() {
        ...
        if (maxStock > 0) {
            ...
            document.getElementById('quantity').setAttribute('max', maxStock);
            document.getElementById('quantity').setAttribute('min', maxStock);
            document.getElementById('quantity').setAttribute('value', maxStock);
        }    
    }
</script>
